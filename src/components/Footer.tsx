        ...
        <nav className="flex items-center gap-6">
          {links.map((link) => (
            <button
              ...
              className="font-inter text-[13px] text-zinc-400 dark:text-zinc-600 hover:text-zinc-800 dark:hover:text-zinc-300 transition-colors duration-200 flex items-center gap-1"
            >
              {link.label}
