...
const GRADIENT = 'linear-gradient(135deg, #417AEA 0%, #15C679 100%)'
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-950">
      ...
      <section className="relative pt-32 pb-14 md:pt-40 md:pb-18 overflow-hidden bg-white dark:bg-zinc-950">
        <div className="absolute inset-0 pointer-events-none">
          <div
            ...
            style={{ background: 'radial-gradient(circle, #417AEA 0%, transparent 70%)' }}
          />
          <div
        ...
        <div className="relative max-w-[1200px] mx-auto px-6 md:px-10">
          ...
          <div className="max-w-[920px]">
            ...
            >
              ...
              <span
                ...
                style={{
                  backgroundImage:
                    'linear-gradient(135deg, #417AEA 0%, #15C679 100%)',
                }}
              >
                inside the chart.
              </span>
          ...
          >
            <Image
              src="/qs-thumbnail.png"
              alt="Quantive Signals case study cover"
              fill
            ...
            <div>
              <FadeIn delay={0.1}>
                <blockquote
                  ...
                  style={{ borderLeft: '3px solid #417AEA' }}
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-[260px_1fr] gap-10 md:gap-20">
            ...
            <div>
              ...
              <FadeIn delay={0.14}>
                ...
                >
                  <p className="font-plus-jakarta font-semibold text-[16px] text-zinc-800 dark:text-zinc-200 mb-3">The gesture conflict:</p>
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <p className="font-dm-sans text-[14px] text-zinc-600 dark:text-zinc-400 leading-relaxed">Click + drag on a chart = annotate a date range with a comment. This was the new feature I needed to introduce.</p>
                    </div>
                  </div>
                  <p className="font-dm-sans text-[13px] text-zinc-500 dark:text-zinc-500 mt-4 italic">
                  ...
                  <div className="flex flex-col md:flex-row md:items-start gap-6 md:gap-10">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-start gap-3 pt-5 border-t border-zinc-100 dark:border-white/[0.05]">
                        <div className="w-1.5 h-1.5 rounded-full flex-shrink-0 mt-[5px]" style={{ backgroundColor: '#417AEA' }} />
          ...
          <FadeIn delay={0.1} className="mt-10">
            <div className="bg-white dark:bg-zinc-900/40 border border-zinc-200 dark:border-white/[0.07] rounded-2xl p-8 md:p-12">
              <div className="flex flex-col md:flex-row items-start gap-6">
                <div className="font-plus-jakarta font-extrabold text-[56px] text-blue-200 dark:text-blue-400/20 leading-none flex-shrink-0 select-none">"</div>
              ...
              <FadeIn key={item.title} delay={i * 0.07}>
                <div className="bg-zinc-50 dark:bg-zinc-900/60 border border-zinc-200 dark:border-white/[0.07] rounded-xl p-6 h-full">
                  <div className="flex items-center gap-3 mb-3">
                    <span className="text-[20px] leading-none" style={{ color: '#417AEA' }}>
                      {item.icon}
                    </span>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={i} className="flex items-start gap-3">
                      <div className="w-1.5 h-1.5 rounded-full flex-shrink-0 mt-[8px]" style={{ backgroundColor: '#417AEA' }} />
      ...
      <section className="py-20 md:py-28 bg-zinc-50 dark:bg-zinc-900/30">
        <div className="max-w-[1200px] mx-auto px-6 md:px-10">
          <FadeIn>
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-white via-white to-[#417AEA]/[0.06] dark:from-zinc-900 dark:via-zinc-900 dark:to-[#417AEA]/[0.08] border border-zinc-200 dark:border-white/[0.07] px-6 py-14 sm:px-12 sm:py-16 md:p-16 text-center">
              <div
                className="absolute top-[-60%] left-1/2 -translate-x-1/2 w-[700px] h-[500px] rounded-full opacity-[0.05] pointer-events-none"
                style={{ background: 'radial-gradient(circle, #417AEA 0%, transparent 70%)' }}
              />
              <div className="relative">
                <p className="section-label mb-5" style={{ color: '#417AEA' }}>
