      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            ...
            >
              {[
                `I'm Suryansh. I've spent 4 years building products across B2B, B2C and SaaS - OKR platforms, health apps, analytics tools, a teen wellbeing app. Enough variety to know that the design problems are usually the same, but the context is everything.`,
