      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-10">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-zinc-50 via-white to-blue-50/60 dark:from-zinc-900 dark:via-zinc-900 dark:to-blue-900/20 border border-zinc-200 dark:border-white/[0.07] px-6 py-10 sm:p-10 md:p-16 text-center">
          ...
          >
            ...
            <h2 className="font-syne font-extrabold text-[clamp(28px,6.5vw,64px)] text-zinc-900 dark:text-zinc-50 tracking-[-0.03em] leading-[1.05] mb-6">
              Got something<br />
              <span className="text-blue-600 dark:text-blue-400">to build?</span>
            </h2>

            <p className="font-inter font-light text-[clamp(15px,2vw,18px)] text-zinc-600 dark:text-zinc-400 leading-[1.7] max-w-[500px] mx-auto mb-10">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 w-full sm:w-auto mx-auto sm:mx-0">
              <motion.a
                ...
                whileTap={{ scale: 0.97 }}
                className="flex items-center justify-center gap-2.5 bg-blue-600 dark:bg-blue-400 text-white dark:text-zinc-950 font-inter font-semibold text-[13px] md:text-[14px] px-6 md:px-8 py-4 rounded-full transition-all duration-200 hover:bg-blue-700 dark:hover:bg-blue-300 min-w-0"
              >
